  ...
  while playerIndex < Universe_PlayerCount() do
    if Player_IsAlive(playerIndex) == 1 then
      if Player_HasShipWithBuildQueue(playerIndex) == 1 then				           
        ...
        SobGroup_Create("hgn_ghost"..playerIndex)    				
        --platform					                      
    ...
    if Player_IsAlive(playerIndex) == 1 then
      if Player_HasShipWithBuildQueue(playerIndex) == 1 then    
        ...
        --Subtitle_Message("Test "..SobGroup_GetHardPointHealth("supporter"..playerIndex, "resistence"), 25)									
          ...
          SobGroup_FillShipsByType("hgn_ghost"..playerIndex, "Player_Ships"..playerIndex, "hgn_ghost") 					
					for ms = 1,6,1 do
					  SobGroup_FillShipsByType("temp", "Player_Ships"..playerIndex, "hgn_massshield_"..ms)  	 
          ...
          SobGroup_SobGroupAdd("utilities"..playerIndex, "hgn_resourcecollector"..playerIndex)
					...
					SobGroup_SobGroupAdd("othersnoparade"..playerIndex, "hgn_ghost"..playerIndex)
