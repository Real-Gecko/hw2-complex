--
GameRulesName = "Complex Deathmatch"
Description = "You can set your game parameters, default settings cause a balanced match (button presets)" 
Directories =
{
...
{
  {
   ...
   tooltip = "CHOOSE THE WIN CONDITION (Default: Destroy Mothership)",
   default = 0,
   visible = 1,
   choices =
   {
  ...
  { 
   ...
   tooltip = "ENABLE/DISABLE SECONDARY OBJECTIVES (Default: No)", 
   default = 1, 
   visible = 1, 
   choices = 
   {
  ...
  },  	
  {
   ...
   choices =
   {
	...
	{
   name = "honourstart",
   locName = "Starting Rank",
   tooltip = "CHOOSE THE AMOUNT OF STARTING HONOUR POINTS (Default: 20)",
   default = 2,
   visible = 1,
   choices =
   {
  ...
  },  	
  {
   ...
   tooltip = "CHOOSE THE NUMBER OF STARTING SHIPS (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },      
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING RUS (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  { 
   ...
   tooltip = "CHOOSE THE MAX CAPACITY OF YOUR FLEET, SETS HOW MANY PILOTS/OFFICERS YOU CAN RECRUIT IN ANY RANK (Default: Normal)", 
   default = 1, 
   visible = 1, 
   choices = 
   { "Few", "1", 
	...
	{
   name = "military",
   locName = "AI Attack Multiplier",
   tooltip = "CHOOSE THE AI BEHAVIOR, FEW: AI ATTACKS RARELY BY MANY SHIPS; HIGH: AI ATTACKS OFTEN BY FEW SHIPS (Default: Normal)",
   default = 2,
   visible = 1,
   choices =
   {
   ...
   tooltip = "ADJUST THE AMOUNT OF RESOURCES PER ASTEROID (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "resource",
   locName = "RU Operations Multiplier",
   tooltip = "CHOOSE THE RESOURCE OPERATIONS SPEED (HARVEST/FUSION/MINING) (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },  	
  {
   ...
   locName = "Honour Multiplier",
   tooltip = "CHOOSE THE HONOUR POINTS SENSITIVITY (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },    
  {
   ...
   locName = "Research Multiplier",
   tooltip = "CHOOSE THE RESEARCH POINTS SENSITIVITY (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "buildspeed",
   locName = "Construction Multiplier",
   tooltip = "CHOOSE THE UNIT CONSTRUCTION SPEED (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "recruiting",
   locName = "Recruiting Multiplier",
   tooltip = "CHOOSE THE RECRUITING OPERATIONS SPEED (CREW/OFFICERS) (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },   
  {
   ...
   locName = "Experience Multiplier",
   tooltip = "CHOOSE THE UNIT EXPERIENCE SENSITIVITY (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },     
  {
   ...
   locName = "Energy Multiplier",
   tooltip = "CHOOSE THE ENERGY SENSITIVITY (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "spacebalancer",
   locName = "Solar Shield Multiplier",
   tooltip = "ADJUST THE EFFECT OF THE DISTANCE FROM THE SUN ON HULL DAMAGE AND ENERGY CONSUME (MAPS WITH PLANETS) (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "popbalancer",
   locName = "Population Multiplier",
   tooltip = "CHOOSE THE RATE OF GROWTH OF THE POPULATION ON PLANETS AND ORBITAL STATIONS (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  {
   name = "hyperspace",
   locName = "Hyperspace Multiplier",
   tooltip = "CHOOSE THE ACCESSIBILITY OF HYPERSPACE OPERATIONS (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  },                                                                        
  {
   ...
   locName = "Rank Remuneration Multiplier",
   tooltip = "CHOOSE THE RANK REMUNERATION PER YEAR (Default: Normal)",
   default = 2,
   visible = 1,
   choices =
   {
  ...
  {
   name = "unithealth",
   locName = "Battle Multiplier",
   tooltip = "CHOOSE THE BATTLE DURATION (UNIT RESISTANCE/FIREPOWER) (Default: Normal)",
   default = 1,
   visible = 1,
   choices =
   {
  ...
  { 
   name = "diplomacy", 
   locName = "Alliance Fee Multiplier", 
   tooltip = "CHOOSE THE ALLIANCE FEE PER YEAR BASED ON ALLIED PLAYER'S SCORE, ALLIED PLAYERS WITH MINOR SCORE PAY RUs (Default: Normal)", 
   default = 2, 
   visible = 1, 
   choices = 
   {
  ...
  { 
   name = "autosave", 
   locName = "Auto Save", 
   tooltip = "CHOSE THE AUTO SAVE MENU TIMING (ONLY SINGLE PLAYER) (Default: No)", 
   default = 3, 
   visible = 1, 
   choices = 
   {    
