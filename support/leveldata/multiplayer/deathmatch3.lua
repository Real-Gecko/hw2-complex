...
Description = "Settings are fixed to maximize the action of the match, it causes fast and short battles with a lot of ships, along few game years" 
Directories =
{
...
---STARTING HONOUR-------------
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING HONOUR POINTS, LESS STARTING HONOUR CAUSES A TACTICAL MATCH (Default: 20)",
   default = 1,
   visible = 0,
   choices =
   {
