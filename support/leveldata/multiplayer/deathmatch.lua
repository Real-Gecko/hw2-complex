...
Description = "Settings are fixed to maximize the action of the match, it causes fast battles with many ships"  
Directories =
{
...
GameSetupOptions =
{
  ...
  },    
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING HONOUR POINTS (Default: 10)",
   default = 3,
   visible = 0,
   choices =
   {
  ...
  },    
  {
   ...
   tooltip = "ADJUST THE EFFECT OF THE DISTANCE FROM THE SUN ON HULL DAMAGE AND ENERGY CONSUME (Default: Normal)",
   default = 2,
   visible = 0,
   choices =
   {
