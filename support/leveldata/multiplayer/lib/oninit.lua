...
function OnInit()     
  ...
  --movies		
	...
	--FUNCTIONS
	if military < 6 then
		Rule_AddInterval("ai", 37.2727) --ok 
	end		
  ...
  Rule_AddInterval("interfacebuttons", 1.25) --ok   
  Rule_AddInterval("selected", 0.7) --ok (runselected) 
  Rule_AddInterval("matchinit", 3) --ok 
  ...
  Rule_AddInterval("fusion", fusionfactor) --ok
	Rule_AddInterval("Jexplosiondamage", 1)
  Rule_AddInterval("MSexplosiondamage", 1.05)
  Rule_AddInterval("SYexplosiondamage", 1.1)
	Rule_AddInterval("PSexplosiondamage", 1.15)  
  Rule_AddInterval("CFexplosiondamage", 1.2)    
  Rule_AddInterval("researching", 16.94) --ok (runselected)
  Rule_AddInterval("maintenance", 59.47) --ok
  Rule_AddInterval("score", 54.43) --ok
  Rule_AddInterval("vipermissile", 2.5) --ok
  Rule_AddInterval("computerspy", 11.1) --ok
  Rule_AddInterval("LOD", 60.33) --ok    
  Rule_AddInterval("aijuggernaught", 5.67)
  Rule_AddInterval("trade", 14.11) --ok 
  Rule_AddInterval("randomfake", 7.45) --ok    
  Rule_AddInterval("weaponsets", 10.51) --ok    	
  Rule_AddInterval("autorepair", 27.22) --ok
  Rule_AddInterval("weight", 57.39) --ok
  Rule_AddInterval("experience", 33.33) --ok 
  Rule_AddInterval("eventi", 9.88) --ok  
