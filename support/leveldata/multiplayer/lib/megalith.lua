    ...
    if Player_IsAlive(playerIndex) == 1 then
      if Player_HasShipWithBuildQueue(playerIndex) == 1 then 
				                ...
				                if SobGroup_IsDockedSobGroup("splitminecontainers"..z, "splitminingbases"..i) == 1 then
				                  if battlearena[1] < 200 then	
							              if (SobGroup_GetHardPointHealth("splitminingbases"..i, "ru")-0.00100) >= (minecontainerrurateList[playerIndexList] / 10) then
							                SobGroup_SetHardPointHealth("splitminecontainers"..z, "ru", (SobGroup_GetHardPointHealth("splitminecontainers"..z, "ru") + minecontainerrurateList[playerIndexList]))  
        ...
        if Player_HasResearch(playerIndex, "isai" ) == 1 then  
					--hiigaran 
	      	if ( Player_GetRace(playerIndex) == Race_Hiigaran ) then 
	          if SobGroup_FillProximitySobGroup ("targetmegalith"..playerIndex, "megalithnoowner", "productioncapital"..playerIndex, 25000) == 1 then                     
                ...
                if SobGroup_AreAnyOfTheseTypes("temp", "hgn_mothership, hgn_shipyard, hgn_battleshipyard, hgn_shipyard_g, hgn_carrier, hgn_battlecarrier") == 1 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_marinefrigate") < 3 and
            ...
            elseif SobGroup_FillProximitySobGroup ("targetmegalith"..playerIndex, "megalitenoowner", "productioncapital"..playerIndex, 25000) == 1 then		                    
                ...
                if SobGroup_AreAnyOfTheseTypes("temp", "hgn_mothership, hgn_shipyard, hgn_battleshipyard, hgn_shipyard_g, hgn_carrier, hgn_battlecarrier") == 1 and
                  ...
                  SobGroup_CreateShip("temp", "hgn_marinefrigate")
						...
						--ai verso pianeta, inserita quì perchè la funzione ai si attiva troppo di rado						
						--mothership
						if SobGroup_Empty("star_sol") == 0 then
						  if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_mothership") > 0 then							
							  if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_mercury") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_venus") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_earth") == 0 and
								   Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_moon") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_mars") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_saturn") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_jupiter") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_europa") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_io") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_callisto") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_ganymeade") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_uranus") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_neptune") == 0 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_pluto") == 0 then
							    SobGroup_Clear("temp")          
									distance = 10000			                     
									while SobGroup_Count("temp") == 0 and distance < 1000000 do                      	              						     
							...
							if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_battlestation") > 0 then							
							  if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_mercury") == 1 then								
								  if SobGroup_FillProximitySobGroup ("temp", "planet_mercury", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_mercury", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end								
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_venus") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_venus", "hgn_battlestation"..playerIndex, 57000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_venus", 47000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_earth") == 1 then		
                  if SobGroup_FillProximitySobGroup ("temp", "planet_earth", "hgn_battlestation"..playerIndex, 57000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_earth", 47000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end												
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_mars") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_mars", "hgn_battlestation"..playerIndex, 57000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_mars", 47000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_saturn") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_saturn", "hgn_battlestation"..playerIndex, 112000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_saturn", 102000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_jupiter") == 1 then	
                  if SobGroup_FillProximitySobGroup ("temp", "planet_jupiter", "hgn_battlestation"..playerIndex, 112000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_jupiter", 102000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end												
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_uranus") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_uranus", "hgn_battlestation"..playerIndex, 72000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_uranus", 62000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_neptune") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_neptune", "hgn_battlestation"..playerIndex, 72000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_neptune", 62000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_pluto") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_pluto", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_pluto", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_ganymeade") == 1 then
                  if SobGroup_FillProximitySobGroup ("temp", "planet_ganymeade", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_ganymeade", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end												
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_callisto") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_callisto", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_callisto", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_europa") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_europa", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_europa", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_io") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_io", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_io", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end				
								elseif Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_planet_moon") == 1 then
								  if SobGroup_FillProximitySobGroup ("temp", "planet_moon", "hgn_battlestation"..playerIndex, 42000) == 0 then
									  if SobGroup_AreAllInHyperspace("hgn_battlestation"..playerIndex) == 1 then                
											SobGroup_ExitHyperSpaceSobGroup("hgn_battlestation"..playerIndex, "planet_moon", 32000)
										else
											SobGroup_EnterHyperSpaceOffMap("hgn_battlestation"..playerIndex)
										end				
									end							    
						...
						--Platforms  
            if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "hgn_mothership") > 0 then                 
              if SobGroup_FillProximitySobGroup ("temp", "hgn_gunturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   
							if SobGroup_FillProximitySobGroup ("temp", "hgn_rapidfiregunturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   
							if SobGroup_FillProximitySobGroup ("temp", "hgn_pulsarturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   
							if SobGroup_FillProximitySobGroup ("temp", "hgn_ionturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   
							if SobGroup_FillProximitySobGroup ("temp", "hgn_missileturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   
							if SobGroup_FillProximitySobGroup ("temp", "hgn_defensefieldturret"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end   							
	            if SobGroup_FillProximitySobGroup ("temp", "hgn_artillerysentinel"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end     
	            if SobGroup_FillProximitySobGroup ("temp", "hgn_rts"..playerIndex, "hgn_mothership"..playerIndex, 10000) == 1 then 
	              SobGroup_ParadeSobGroup("temp", "hgn_mothership"..playerIndex, 0)
	            end          		        
							--Research Station                    
	          ...
	          if SobGroup_FillProximitySobGroup ("targetmegalith"..playerIndex, "megalithnoowner", "productioncapital"..playerIndex, 25000) == 1 then                     
                ...
                if SobGroup_AreAnyOfTheseTypes("temp", "vgr_mothership, vgr_shipyard, vgr_carrier") == 1 and
									 Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "vgr_infiltratorfrigate") < 3 and
            ...
            if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(playerIndex, "vgr_mothership") > 0 then  	            
	            if SobGroup_FillProximitySobGroup ("temp", "vgr_weaponplatform_gun"..playerIndex, "vgr_mothership"..playerIndex, 10000) == 1 then 
		            SobGroup_ParadeSobGroup("temp", "vgr_mothership"..playerIndex, 0)
		          end 
							if SobGroup_FillProximitySobGroup ("temp", "vgr_weaponplatform_lance"..playerIndex, "vgr_mothership"..playerIndex, 10000) == 1 then 
		            SobGroup_ParadeSobGroup("temp", "vgr_mothership"..playerIndex, 0)
		          end 
              if SobGroup_FillProximitySobGroup ("temp", "vgr_weaponplatform_missile"..playerIndex, "vgr_mothership"..playerIndex, 10000) == 1 then 
		            SobGroup_ParadeSobGroup("temp", "vgr_mothership"..playerIndex, 0)
		          end 			
              if SobGroup_FillProximitySobGroup ("temp", "vgr_am"..playerIndex, "vgr_mothership"..playerIndex, 20000) == 1 then 
		            SobGroup_MoveToSobGroup("temp", "vgr_mothership"..playerIndex)
		          end 							
           	end
	        end 	
	      end
