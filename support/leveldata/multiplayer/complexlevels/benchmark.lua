--
GameRulesName = "<c=b0b0b0>Benchmark</c>"
Description = "Test your PC inside the battle, watch what the Complex engine can do, use the Complex cinematic and set your in-game Unit Capacity based on what you see" 
Directories =
{
  --Levels = "data:LevelData\\Multiplayer\\complexlevels\\",  
	Levels = "data:LevelData\\Multiplayer\\benchmark\\",  
}
---GAME SETUP----------------------------------------------------------------------------------------------
GameSetupOptions =
{
...
---STARTING FLEET--------------------
  {
   ...
   tooltip = "CHOOSE THE MAX CAPACITY OF YOUR FLEET AND THE BATTLE SIZE",
   default = 2,
   visible = 1,
   choices =
   {
