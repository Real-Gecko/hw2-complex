GameRulesName="Complex Carnage"
Description = "Settings are fixed to maximize the speed and the action of the match, very fast, it causes frenetic and very short battles with a lot of ships, along few game years" 
Directories =
{
...
---RESOURCE MULITPLIER----------------
  {
   ...
   tooltip = "ADJUST THE AMOUNT OF RESOURCES PER ASTEROID, FEW RESOURCES CAUSE A TACTICAL MATCH (Default: High)",
   default = 1,
   visible = 0,
   choices =
   {
...
---STARTING RESOURCE OPTION-------------
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING RUS, FEW RESOURCES CAUSE A TACTICAL MATCH (Default: High)",
   default = 1,
   visible = 0,
   choices =
   {
...
---STARTING HONOUR-------------
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING HONOUR POINTS, LESS STARTING HONOUR HONOUR CAUSES A TACTICAL MATCH (Default: 20)",
   default = 2,
   visible = 0,
   choices =
   {
...
---DIPLOMACY FEE--------------------------
  { 
   ...
   tooltip = "CHOOSE THE DIPLOMACY FEE PER YEAR BASED ON ALLIED PLAYER'S SCORE, PLAYERS WITH MINOR SCORE PAY RUs (Default: Normal)", 
   default = 2, 
   visible = 1, 
   choices = 
   {
