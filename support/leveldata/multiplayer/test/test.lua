--
GameRulesName = "Complex Dev."
Description = "Used for Complex development" 
Directories =
{
  --Levels = "data:LevelData\\Multiplayer\\complexlevels\\",  
	Levels = "data:LevelData\\Multiplayer\\test\\",  
}
---GAME SETUP----------------------------------------------------------------------------------------------
GameSetupOptions =
{
...
---AI--------------------------
  {
   name = "aiaids",
   locName = "AI Aids",
   tooltip = "CHOOSE THE FREQUENCY OF ARTIFICIAL INTELLIGENT AIDS, FEW AIDS CAUSE A TACTICAL MATCH (Default: Few)",
   default = 1,
   visible = 1,
   choices =
   {
...
---DIPLOMACY FEE--------------------------
  { 
   ...
   tooltip = "CHOOSE THE DIPLOMACY FEE PER YEAR BASED ON ALLIED PLAYER'S SCORE, ALLIED PLAYERS WITH MINOR SCORE PAY RUs (Default: None)", 
   default = 0, 
   visible = 1, 
   choices = 
   {
...
---UNLOCK SPECIAL UNITS------------
  { 
   name = "unlockspecial", 
   locName = "Unlock Special", 
   tooltip = "UNLOCK SPECIAL UNITS (Default: no)", 
   default = 1, 
   visible = 1, 
   choices = 
   {
