--
GameRulesName = "Complex Tactical"
Description = "Settings are fixed to maximize the tactic of the match, very slow, it causes tactical and long battles with a lot of ships, along many game years" 
Directories =
{
...
---STARTING RESOURCE OPTION-------------
  {
   ...
   tooltip = "CHOOSE THE AMOUNT OF STARTING RUS, FEW RESOURCES CAUSE A TACTICAL MATCH (Default: Few)",
   default = 1,
   visible = 0,
   choices =
   {
...
---BATTLE DURATION-------------
  {
   ...
   tooltip = "CHOOSE THE BATTLE DURATION, UNIT RESISTENCE/FIRE POWER (Default: Normal)",
   default = 2,
   visible = 0,
   choices =
   {
