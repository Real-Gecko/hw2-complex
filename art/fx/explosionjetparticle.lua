	...
	properties = {
		property_16 = {
			...
			value = {
				...
				1.0,
				0.5,
				0.33, -- narrows the jets of flame as they expand away from the core.
				1,
				0,
			},
		},
		...
		property_06 = {
			...
			value = {
				...
				30,
				1,
				90, --effects are getting smaller as speed stays the same, so... increase spawn rate.
			},
		},
		property_05 = {
			name = "Emitter_Drag",
