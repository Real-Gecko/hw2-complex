...
{ 
    ...
    { 
        ...
        { 
            ...
            value = 
                { 0, 0.085, 0.5, 0.15, 1, 0.085, }, },  --the entire effect is entity scaled for a destroyer. We'll see how that holds up.
        property_15 = 
        { 
        ...
        { 
            ...
            type = "VARTYPE_ARRAY_TIMEFLOAT", 
            value = 
                { 0, 200, 0.2, 0, 1, 0, }, }, --emitter rate tweaks shouldn't change the timeframe
        property_05 = 
        { 
            name = "Emitter_Drag", 
            type = "VARTYPE_FLOAT", 
        ...
        { 
            ...
            type = "VARTYPE_ARRAY_TIMEFLOAT", 
            value = 
                { 0,8,2,6,4,0, }, },   --was 10 and 5 with higher drag
        property_12 = 
        { 
