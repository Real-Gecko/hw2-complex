fx = {
    ...
    properties = {
        ...
        property_06 = {
            name = "Emitter_Rate",
            type = "VARTYPE_ARRAY_TIMEFLOAT",
            value = { 0, 270, 0.65, 50, 1, 0, }, }, --was 28 then 128
        property_05 = {
            name = "Emitter_Drag",
            type = "VARTYPE_FLOAT",
            value = 0.95, }, --0.8 produces an ambient field of sparks. Interesting.
        property_08 = {
            name = "Emitter_Deviation",
            type = "VARTYPE_ARRAY_TIMEFLOAT",
            value = { 0, 360, 1, 360, }, }, --was 360, trying spinning
        property_07 = {
