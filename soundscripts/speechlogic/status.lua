...
-- 5/23/2004 7:30:55 PM
-- LuaDC by Age2uN
-- on error send source file (compiled lua) and this outputfile to Age2uN@gmx.net
--
g_default_frequency = 10
g_low_frequency = 30
...
attackMap = {}
attackMap.STRIKE = 
    { "STATUS_StrikeGroup_UnderAttack", NameAllPilot, NumAllPilots, }
attackMap.Hgn_ResourceController = 
    { "STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots, }
attackMap.Hgn_Interceptor = 
    { "STATUS_Int_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Hgn_AttackBomber = 
    { "STATUS_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Hgn_AssaultCorvette = 
    { "STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Hgn_MinelayerCorvette = 
    { "STATUS_Minelayer_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Hgn_MarineFrigate = 
    { "STATUS_MarineFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_TorpedoFrigate = 
    { "STATUS_TorpFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_IonCannonFrigate = 
    { "STATUS_IonFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_DefenseFieldFrigate = 
    { "STATUS_DDFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_SupportFrigate = 
    { "STATUS_SupportFrigate_Under_Attack", NameSupportPilot, NumSupportPilots, }
attackMap.Hgn_Destroyer = 
    { "STATUS_Destroyer_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_Battlecruiser = 
    { "STATUS_Battlecruiser_Attack", NameCapPilot, NumCapPilots, }
attackMap.Hgn_Shipyard = 
    { "STATUS_Shipyard_Under_Attack", NameSupportPilot, NumSupportPilots, }
attackMap.Vgr_Interceptor = 
    { "STATUS_V_Int_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_Crusader = 
    { "STATUS_V_Crusader_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_LanceFighter = 
    { "STATUS_V_LanceFighter_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_Bomber = 
    { "STATUS_V_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_LaserCorvette = 
    { "STATUS_V_LaserCorvette_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_MissileCorvette = 
    { "STATUS_V_MissileCorvette_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_MinelayerCorvette = 
    { "STATUS_V_Minelayer_Under_Attack", NameFighterPilot, NumFighterPilots, }
attackMap.Vgr_CommandCorvette = 
    { "STATUS_COMMANDCorvette_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Vgr_InfiltratorFrigate = 
    { "STATUS_V_InfFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Vgr_HeavyMissileFrigate = 
    { "STATUS_V_HMFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Vgr_TransportFrigate = 
    { "STATUS_V_SupportFrigate_Under_Attack", NameSupportPilot, NumSupportPilots, }
attackMap.Vgr_Destroyer = 
    { "STATUS_V_Destroyer_Under_Attack", NameCapPilot, NumCapPilots, }
attackMap.Vgr_Battlecruiser = 
    { "STATUS_V_Battlecruiser_Attack", NameCapPilot, NumCapPilots, }
attackMap.Vgr_ShipYard = 
    { "STATUS_V_Shipyard_Under_Attack", NameSupportPilot, NumSupportPilots, }
attackMapFC = {}
...
ssMap.MotherShip = {}
--ssMap.Crewstation = {}
ssMap.Battlecruiser.BATTLECRUISERENGINE = 
    { "STATUS_BATTLECRUISER_EnginesUnderAttack_1", "STATUS_BATTLECRUISER_EnginesDamaged_1", "STATUS_BATTLECRUISER_EnginesDisabled_1", }
ssMap.Battlecruiser.C_MODULE_CLOAKGENERATOR = 
    { "STATUS_BATTLECRUISER_CloakGeneratorUnderAttack_1", "STATUS_BATTLECRUISER_CloakGeneratorDamaged_1", "STATUS_BATTLECRUISER_CloakGeneratorDestroyed_1", }
ssMap.Battlecruiser.C_MODULE_FIRECONTROL = 
    { "STATUS_BATTLECRUISER_FireControlTowerUnderAttack_1", "STATUS_BATTLECRUISER_FireControlTowerDamaged_1", "STATUS_BATTLECRUISER_FireControlTowerDestroyed_1", }
ssMap.Battlecruiser.C_MODULE_HYPERSPACE = 
    { "STATUS_BATTLECRUISER_HyperspaceCoreUnderAttack_1", "STATUS_BATTLECRUISER_HyperspaceCoreDamaged_1", "STATUS_BATTLECRUISER_HyperspaceCoreDestroyed_1", }
ssMap.Battlecruiser.C_MODULE_RESEARCH = 
    { "STATUS_BATTLECRUISER_ResearchModuleUnderAttack_1", "STATUS_BATTLECRUISER_ResearchModuleDamaged_1", "STATUS_BATTLECRUISER_ResearchModuleDestroyed_1", }
ssMap.Carrier.C_ENGINE = 
    { "STATUS_CARRIER_EnginesUnderAttack_1", "STATUS_CARRIER_EnginesDamaged_1", "STATUS_CARRIER_EnginesDisabled_1", }
ssMap.Carrier.C_MODULE_CLOAKGENERATOR = 
    { "STATUS_CARRIER_CloakGeneratorUnderAttack_1", "STATUS_CARRIER_CloakGeneratorDamaged_1", "STATUS_CARRIER_CloakGeneratorDestroyed_1", }
ssMap.Carrier.C_MODULE_FIRECONTROL = 
    { "STATUS_CARRIER_FireControlTowerUnderAttack_1", "STATUS_CARRIER_FireControlTowerDamaged_1", "STATUS_CARRIER_FireControlTowerDestroyed_1", }
ssMap.Carrier.C_MODULE_HYPERSPACE = 
    { "STATUS_CARRIER_HyperspaceCoreUnderAttack_1", "STATUS_CARRIER_HyperspaceCoreDamaged_1", "STATUS_CARRIER_HyperspaceCoreDestroyed_1", }
ssMap.Carrier.C_MODULE_PLATFORMCONTROL = 
    { "STATUS_CARRIER_PlatformFacilityUnderAttack_1", "STATUS_CARRIER_PlatformFacilityDamaged_1", "STATUS_CARRIER_PlatformFacilityDestroyed_1", }
ssMap.Carrier.C_MODULE_RESEARCH = 
    { "STATUS_CARRIER_ResearchModuleUnderAttack_1", "STATUS_CARRIER_ResearchModuleDamaged_1", "STATUS_CARRIER_ResearchModuleDestroyed_1", }
ssMap.Carrier.C_PRODUCTION_CORVETTE = 
    { "STATUS_CARRIER_CorvetteFacilityUnderAttack_1", "STATUS_CARRIER_CorvetteFacilityDamaged_1", "STATUS_CARRIER_CorvetteFacilityDestroyed_1", }
ssMap.Carrier.C_PRODUCTION_FIGHTER = 
    { "STATUS_CARRIER_FighterFacilityUnderAttack_1", "STATUS_CARRIER_FighterFacilityDamaged_1", "STATUS_CARRIER_FighterFacilityDestroyed_1", }
ssMap.Carrier.C_PRODUCTION_FRIGATE = 
    { "STATUS_CARRIER_FrigateFacilityUnderAttack_1", "STATUS_CARRIER_FrigateFacilityDamaged_1", "STATUS_CARRIER_FrigateFacilityDestroyed_1", }
ssMap.Carrier.C_PRODUCTION_FRIGATEADVANCED = 
    { "STATUS_CARRIER_AdvancedFrigateFacilityUnderAttack_1", "STATUS_CARRIER_AdvancedFrigateFacilityDamaged_1", "STATUS_CARRIER_AdvancedFrigateFacilityDestroyed_1", }
ssMap.Carrier.C_SENSORS_ADVANCEDARRAY = 
    { "STATUS_CARRIER_SensorArrayUnderAttack_1", "STATUS_CARRIER_SensorArrayDamaged_1", "STATUS_CARRIER_SensorArrayDestroyed_1", }
ssMap.Shipyard.MS_MODULE_CLOAKGENERATOR = 
    { "STATUS_SHIPYARD_CloakGeneratorUnderAttack_1", "STATUS_SHIPYARD_CloakGeneratorDamaged_1", "STATUS_SHIPYARD_CloakGeneratorDestroyed_1", }
ssMap.Shipyard.MS_MODULE_FIRECONTROL = 
    { "STATUS_SHIPYARD_FireControlTowerUnderAttack_1", "STATUS_SHIPYARD_FireControlTowerDamaged_1", "STATUS_SHIPYARD_FireControlTowerDestroyed_1", }
ssMap.Shipyard.MS_MODULE_HYPERSPACE = 
    { "STATUS_SHIPYARD_HyperspaceCoreUnderAttack_1", "STATUS_SHIPYARD_HyperspaceCoreDamaged_1", "STATUS_SHIPYARD_HyperspaceCoreDestroyed_1", }
ssMap.Shipyard.MS_MODULE_RESEARCH = 
    { "STATUS_SHIPYARD_ResearchModuleUnderAttack_1", "STATUS_SHIPYARD_ResearchModuleDamaged_1", "STATUS_SHIPYARD_ResearchModuleDestroyed_1", }
ssMap.Shipyard.MS_MODULE_PLATFORMCONTROL = 
    { "STATUS_SHIPYARD_PlatformFacilityUnderAttack_1", "STATUS_SHIPYARD_PlatformFacilityDamaged_1", "STATUS_SHIPYARD_PlatformFacilityDestroyed_1", }
ssMap.Shipyard.MS_PRODUCTION_CORVETTE = 
...
ssMap.Shipyard.MS_PRODUCTION_FIGHTER = 
    { "STATUS_SHIPYARD_FighterFacilityUnderAttack_1", "STATUS_SHIPYARD_FighterFacilityDamaged_1", "STATUS_SHIPYARD_FighterFacilityDestroyed_1", }
ssMap.Shipyard.MS_PRODUCTION_FRIGATE = 
    { "STATUS_SHIPYARD_FrigateFacilityUnderAttack_1", "STATUS_SHIPYARD_FrigateFacilityDamaged_1", "STATUS_SHIPYARD_FrigateFacilityDestroyed_1", }
ssMap.Shipyard.MS_PRODUCTION_FRIGATEADVANCED = 
...
ssMap.Shipyard.SY_INNATE_ENGINE = 
    { "STATUS_SHIPYARD_EnginesUnderAttack_1", "STATUS_SHIPYARD_EnginesDamaged_1", "STATUS_SHIPYARD_EnginesDisabled_1", }
ssMap.Shipyard.SY_PRODUCTION_CAPSHIP = 
    { "STATUS_SHIPYARD_CapitalShipFacilityUnderAttack_1", "STATUS_SHIPYARD_CapitalShipFacilityDamaged_1", "STATUS_SHIPYARD_CapitalShipFacilityDestroyed_1", }
ssMap.MotherShip.MS_MODULE_CLOAKGENERATOR = 
    { "STATUS_Mothership_CloakGeneratorUnderAttack_1", "STATUS_Mothership_CloakGeneratorDamaged_1", "STATUS_Mothership_CloakGeneratorDestroyed_1", }
ssMap.MotherShip.MS_MODULE_FIRECONTROL = 
    { "STATUS_Mothership_FireControlTowerUnderAttack_1", "STATUS_Mothership_FireControlTowerDamaged_1", "STATUS_Mothership_FireControlTowerDestroyed_1", }
ssMap.MotherShip.MS_MODULE_HYPERSPACE = 
    { "STATUS_Mothership_HyperspaceCoreUnderAttack_1", "STATUS_Mothership_HyperspaceCoreDamaged_1", "STATUS_Mothership_HyperspaceCoreDestroyed_1", }
ssMap.MotherShip.MS_MODULE_RESEARCH = 
    { "STATUS_Mothership_ResearchModuleUnderAttack_1", "STATUS_Mothership_ResearchModuleDamaged_1", "STATUS_Mothership_ResearchModuleDestroyed_1", }
ssMap.MotherShip.MS_MODULE_PLATFORMCONTROL = 
    { "STATUS_Mothership_PlatformFacilityUnderAttack_1", "STATUS_Mothership_CorvetteFacilityDamaged_1", "STATUS_Mothership_PlatformFacilityDestroyed_1", }
ssMap.MotherShip.MS_PRODUCTION_CORVETTE = 
    { "STATUS_Mothership_CorvetteFacilityUnderAttack_1", "STATUS_SHIPYARD_CorvetteFacilityDamaged_1", "STATUS_Mothership_CorvetteFacilityDestroyed_1", }
ssMap.MotherShip.MS_PRODUCTION_FIGHTER = 
    { "STATUS_Mothership_FighterFacilityUnderAttack_1", "STATUS_Mothership_FighterFacilityDamaged_1", "STATUS_Mothership_FighterFacilityDestroyed_1", }
ssMap.MotherShip.MS_PRODUCTION_FRIGATE = 
    { "STATUS_Mothership_FrigateFacilityUnderAttack_1", "STATUS_SHIPYARD_FrigateFacilityDamaged_1", "STATUS_Mothership_FrigateFacilityDestroyed_1", }
ssMap.MotherShip.MS_PRODUCTION_FRIGATEADVANCED = 
    { "STATUS_Mothership_AdvancedFrigateFacilityUnderAttack_1", "STATUS_Mothership_AdvancedFrigateFacilityDamaged_1", "STATUS_Mothership_AdvancedFrigateFacilityDestroyed_1", }
ssMap.MotherShip.MS_INNATE_ENGINE = 
    { "STATUS_Mothership_EnginesUnderAttack_1", "STATUS_Mothership_EnginesDamaged_1", "STATUS_Mothership_EnginesDisabled_1", }
ssMap.MotherShip.MS_PRODUCTION_CAPSHIP = 
    { "STATUS_Mothership_CapitalShipFacilityUnderAttack_1", "STATUS_Mothership_CapitalShipFacilityDamaged_1", "STATUS_Mothership_CapitalShipFacilityDestroyed_1", }
ssMap.MotherShip.MS_SENSORS_ADVANCEDARRAY = 
    { "STATUS_Mothership_SensorArrayUnderAttack_1", "STATUS_Mothership_SensorArrayDamaged_1", "STATUS_Mothership_SensorArrayDestroyed_1", }
ssMap.MotherShip.MS_PRODUCTION_CAPSHIPADVANCED = 
    { "STATUS_Mothership_AdvancedCapitalShipFacilityUnderAttack_1", "STATUS_Mothership_AdvancedCapitalShipFacilityDamaged_1", "STATUS_Mothership_AdvancedCapitalShipFacilityDestroyed_1", }
ssMap.MotherShip.MS_MODULE_RESEARCHADVANCED = 
    { "STATUS_ARM_UnderAttack_2", "STATUS_ARM_Damaged_1", "STATUS_ARM_Destroyed_1", }
--ssMap.Crewstation.PILOTMODULE = 
--    { "", "", "STATUS_UNITCAPDECREASED_1", }    
...
function ChatterMisc(shipnm, parm2, code)
    ...
    if  code==CD_MissileIncoming and shiptype==Capital then
...
function StatusCloud(shipname, evtype)
    ...
    elseif  evtype==CLOUD_EnteringNebula then
        ...
        if  strupper(shipname, "PROBE") then
            return
        end 
...
function StatusSubsystem(ssname, shipName, event)
    ...
    if  strfind(genericssname, "ENGINE") then
    ...
    if  ssMap[""..genericShipName] and ssMap[""..genericShipName][""..genericssname] and event~=Repaired then
...
function StatusBuildAvailable(shipName)
    ...
    shipType = getType(shipName)
    if shipType==MISC then
      print("unit cap limit reached "..shipName.."  "..familyName)
      playSpeechActor("", raceHelper(), 0, Frequency_Status)
    else  
	    if  shipName=="" then
	        print("generic build available "..shipName.."  "..familyName)
	        playSpeechActor("STATUS_BuildAvaliable_1", raceHelper(), 0, Frequency_Status)
	    elseif  shipType==CREW then
	        print("unit cap increased "..shipName.."  "..familyName)
	        playSpeechActor("STATUS_UNITCAPINCREASED_1", raceHelper(), 0, Frequency_Status)
	    elseif  shipType==Resource then
	    ...
	    elseif  shipName=="ADVANCEDRESEARCH1" then
	        print("advresearch build available "..shipName.."  "..familyName)
	        playSpeechActor("STATUS_AdvReseachModAvaliable", raceHelper(), 0, Frequency_Status)     
	    else
	        print("generic build available "..shipName.."  "..familyName)
