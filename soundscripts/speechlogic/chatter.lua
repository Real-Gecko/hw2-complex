...
ChatterEvents = 
    ...
    { 
        ...
        customFnc = 
            { "CommandMoveGiven", F_SS, }, }, 
    { 
        id = CE_CMD_WPMOVE, 
        name = "CommandWayPointMoveGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandWayPointMoveGiven", F_SS, }, }, 
    { 
        id = CE_CMD_MOVETOSOB, 
        name = "CommandMoveToSobGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandMoveToSobGiven", F_SS, }, }, 
    { 
        id = CE_CMD_IDLE, 
        ...
        actor = 
            { NameAllPilot, NumAllPilots, }, }, 
    { 
        id = CE_CMD_RESOURCE, 
        name = "CommandResourceGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandResourceGiven", F_SS, }, }, 
    { 
        id = CE_CMD_CAPTURE, 
        name = "CommandCaptureGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandCaptureGiven", F_SS, }, }, 
    { 
        id = CE_CMD_ATTACK, 
        name = "CommandAttackGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandAttackGiven", F_SSN, }, }, 
    { 
        id = CE_CMD_LAUNCH, 
        name = "CommandLaunchGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandLaunchGiven", F_SS, }, }, 
    { 
        id = CE_CMD_GUARD, 
        name = "CommandGuardGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandGuardGiven", F_SS, }, }, 
    { 
        id = CE_CMD_DOCK, 
        name = "CommandDockGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandDockGiven", F_SS, }, }, 
    { 
        id = CE_CMD_PARADE, 
        name = "CommandParadeGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandParadeGiven", F_SS, }, }, 
    { 
        id = CE_CMD_RETIRE, 
        name = "CommandRetireGiven", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandRetireGiven", F_SS, }, }, 
    { 
        id = CE_CMD_COULDNOT, 
    ...
    { 
        ...
        actor = 
            { NameSupportPilot, NumSupportPilots, }, }, 
    { 
    ...
    { 
        ...
        name = "CommandHyperspaceGateLinked", 
        probability = "CommandProb", 
    ...
    { 
        ...
        probability = "StatusProbHighNoRepeatLocation", 
        customFnc = 
            { "StatusUnderAttack", F_SSN, }, }, 
    { 
        id = CE_STS_SUBSYS, 
        name = "StatusSubsystem", 
        probability = "StatusProbHighNoRepeatLocation", 
        customFnc = 
            { "StatusSubsystem", F_SSN, }, }, 
    { 
    ...
    { 
        ...
        probability = "CommandProb", 
        customFnc = 
            { "ChatterMiscHighPriority", F_SSN, }, }, 
    { 
        id = CE_CHT_MULTIPLAY, 
        name = "CommandMultiplay", 
        probability = "CommandProb", 
        customFnc = 
            { "CommandMultiplay", F_SN, }, }, 
    }
