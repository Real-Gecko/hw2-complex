MusicMenu = 
{
  onShow = "UI_SetButtonPressed('New1', 'btnMusicPlayer', 1)",
	onHide = "UI_SetButtonPressed('New1', 'btnMusicPlayer', 0)",
	size = {214,418,374,34,},
	...
	;	
	{
		...
		}, 
		{
			...
			{ 
				...
				position = { 74, 2, }, 
				size = {22,14,},
				helpTip = "DYNAMIC RANDOM",
				helpTipTextLabel = "commandsHelpTip",
				helpTipScreen = "NewTaskbar",
				name = "RandomPlayDynamic",
				onMouseClicked = "UI_SetElementVisible('MusicMenu','MusicPlayType4',1)",
				DefaultGraphic = 
				{
					texture = "DATA:UI\\NewUI\\musicmenuimage\\MusicPlayerIcons.tga",
					textureUV = {72,43,105,63,},
