...
BuildQueueMenu = {
	...
	onShow = "UI_SetButtonPressed('NewTaskbar', 'BQ', 1); UI_HideScreen('UnitCapInfoPopup'); UI_HideScreen('UnitCapInfoPopup1'); UI_HideScreen('YearMenu'); UI_HideScreen('EnergyMenu')",
	onHide = "UI_SetButtonPressed('NewTaskbar', 'BQ', 0)",
