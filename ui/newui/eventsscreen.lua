...
BOTTOMYPOS = 497
EventsScreen = {
    size = { 2, (BOTTOMYPOS + -2), SCREENWIDTH, 2, },
    stylesheet = "HW2StyleSheet",
    pixelUVCoords = 1,
    soundOnShow = "SFX_RecallMenuONOFF",
    soundOnHide = "SFX_RecallMenuONOFF",
    onShow = "UI_SetButtonPressed('NewTaskbar', 'btnEvents_wide', 1)",
    onHide = "UI_SetButtonPressed('NewTaskbar', 'btnEvents_wide', 0)",
    RootElementSettings = {
        autosize = 1, },
    Regions = {
        { 0, 0, 22, -1, },
    ...
    bottomYPos = BOTTOMYPOS;
    {
        type = "Frame",
        position = { 0, 0, },
        maxSize = { SCREENWIDTH, SCREENHEIGHT, },
        size = { SCREENWIDTH, 2, },
        name = "listEvents",
        autosize = 1,
        autoarrange = 1,
