...
DISABLEDICONCOLOR = { 200, 200, 200, 100, }

ITEMDEFAULTCOLOR = { 125, 125, 125, 225, }
...
NewBuildMenu = {
	...
	onShow = "UI_SubtitleNarrow(); UI_HideScreen('NewManageMenu'); UI_HideScreen('NewResearchMenu'); UI_HideScreen('NewLaunchMenu')",
	...
	-- NOTICE: The names of these buttons must match the family names (the strcmp is case insensitive)
	{
		...
		},
		{
			...
			helpTipTextLabel = "lblCurrentFacility";
			{
				...
				giveParentMouseInput = 1,
				BackgroundGraphic = {
					texture = "DATA:\\Ship\\Icons\\ships\\ru.tga",
					textureUV = { 0, 0, 65, 65, },
				},
			},
		},
	...
	GetCollapsableQueue(OUTLINECOLOR, SHIPQUEUECOLOR, 73),
